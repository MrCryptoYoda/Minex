...
export function ProjectRow({
  ...
  return (
    <Card className={cn("group bg-white rounded-2xl p-3 shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 flex items-center gap-4", className)}>
      {/* Image Container */}
      <div className="relative h-24 w-32 overflow-hidden shrink-0 rounded-xl bg-slate-100">
      ...
      <div className="flex-1 min-w-0 py-1">
        ...
        <p className="text-slate-500 text-xs leading-relaxed line-clamp-1 mb-3 pr-4">
          {description}
        </p>
