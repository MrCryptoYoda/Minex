...
export function ProjectCard({
  ...
  return (
    <Card className={cn("group h-full bg-white rounded-[32px] p-3 shadow-sm hover:shadow-lg transition-all duration-300 border border-slate-100 flex flex-col", className)}>
      {/* Image Container */}
