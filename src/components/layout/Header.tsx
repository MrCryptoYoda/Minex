          ...
          <nav className={cn(
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-[800px] p-0">
                <div className="grid grid-cols-4 gap-6 p-6">
                  {COMMODITY_TAXONOMY.map((sector) => (
                    <div key={sector.id} className="space-y-3">
                      <h4 className="font-semibold text-sm text-slate-900 border-b border-slate-100 pb-2">{sector.name}</h4>
                      <ul className="space-y-1">
                        {sector.commodities.slice(0, 5).map((commodity) => (
                          <li key={commodity.id}>
                            <Link 
                              to={`/search?commodity=${commodity.id}`}
                              className="text-sm text-slate-500 hover:text-brand-orange hover:bg-slate-50 px-2 py-1.5 rounded-md transition-colors block"
                            >
                              {commodity.name}
                            </Link>
                          </li>
                ...
                <div className="bg-slate-50 p-4 border-t border-slate-100 flex justify-between items-center">
                  <p className="text-sm text-slate-500">Looking for something specific?</p>
                  <Button variant="outline" size="sm" className="bg-white border-slate-200 text-brand-orange hover:bg-brand-orange hover:text-white transition-colors" asChild>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-[600px] p-0">
                <div className="grid grid-cols-3 gap-6 p-6">
                  {LOCATION_TAXONOMY.map((region) => (
                    <div key={region.id} className="space-y-3">
                      <h4 className="font-semibold text-sm text-slate-900 border-b border-slate-100 pb-2">{region.name}</h4>
                      <ul className="space-y-1">
                ...
                <div className="bg-slate-50 p-4 border-t border-slate-100 flex justify-between items-center">
                  <p className="text-sm text-slate-500">Explore by map?</p>
                  <Button variant="outline" size="sm" className="bg-white border-slate-200 text-brand-orange hover:bg-brand-orange hover:text-white transition-colors" asChild>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-80 p-0">
                <div className="p-4 border-b border-slate-100">
                  <h4 className="font-semibold text-sm text-slate-900">Select Asset Type</h4>
                  <p className="text-xs text-slate-500 mt-1">Choose the category that best fits your asset.</p>
                </div>
                <div className="p-2 space-y-1">
                  <DropdownMenuItem asChild className="cursor-pointer rounded-lg px-3 py-2.5 focus:bg-slate-50">
                    <Link to="/list/mining-project/step/1" className="flex items-start gap-3">
                      <div className="bg-slate-100 p-2 rounded-md mt-0.5">
                        <Pickaxe className="h-4 w-4 text-slate-600" />
                      </div>
                      <div>
                        <span className="text-sm font-medium text-slate-900 block">Mining Project</span>
                        <span className="text-xs text-slate-500 block mt-0.5">Exploration, Development, Production</span>
                      </div>
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="cursor-pointer rounded-lg px-3 py-2.5 focus:bg-slate-50">
                    <Link to="/list/renewable-asset/step/1" className="flex items-start gap-3">
                      ...
                      <div>
                        <span className="text-sm font-medium text-slate-900 block">Renewable Asset</span>
                        <span className="text-xs text-slate-500 block mt-0.5">Solar, Wind, Hydro Projects</span>
                      </div>
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="cursor-pointer rounded-lg px-3 py-2.5 focus:bg-slate-50">
                    <Link to="/list/claim/step/1" className="flex items-start gap-3">
                      ...
                      <div>
                        <span className="text-sm font-medium text-slate-900 block">Claim</span>
                        <span className="text-xs text-slate-500 block mt-0.5">Mineral Rights & Tenements</span>
                      </div>
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild className="cursor-pointer rounded-lg px-3 py-2.5 focus:bg-slate-50">
                    <Link to="/list/royalty-asset/step/1" className="flex items-start gap-3">
                      ...
                      <div>
                        <span className="text-sm font-medium text-slate-900 block">Royalty Asset</span>
                        <span className="text-xs text-slate-500 block mt-0.5">NSR, GRR, Streaming</span>
                      </div>
                    </Link>
                  </DropdownMenuItem>
                ...
                <div className="bg-slate-50 p-3 border-t border-slate-100 text-center">
                  <p className="text-xs text-slate-500">Need help listing? <Link to="/enquiry" className="text-brand-orange font-medium hover:underline">Contact Support</Link></p>
                </div>
              </DropdownMenuContent>
            </DropdownMenu>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-[600px] p-0 overflow-hidden">
                <div className="grid grid-cols-3 bg-white h-full">
                  <div className="col-span-2 p-6">
                    <div className="grid grid-cols-2 gap-8">
                      <div>
                        <h4 className="font-semibold text-sm mb-4 text-slate-900 flex items-center gap-2">
                          <LayoutDashboard className="h-4 w-4 text-slate-400" /> Platform
                        </h4>
                        <ul className="space-y-2">
                          <li>
                            <Link to="/agents" className="flex items-center gap-3 text-sm text-slate-600 hover:text-brand-orange p-2 rounded-lg hover:bg-slate-50 transition-colors">
                              <Users className="h-4 w-4 text-slate-400" /> 
                              <span>Explore Agents</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/agents/become" className="flex items-center gap-3 text-sm text-slate-600 hover:text-brand-orange p-2 rounded-lg hover:bg-slate-50 transition-colors">
                              <Briefcase className="h-4 w-4 text-slate-400" /> 
                              <span>Become an Agent</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/how-to-guides" className="flex items-center gap-3 text-sm text-slate-600 hover:text-brand-orange p-2 rounded-lg hover:bg-slate-50 transition-colors">
                              <BookOpen className="h-4 w-4 text-slate-400" /> 
                              <span>How-To Guides</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/buyer-interest" className="flex items-center gap-3 text-sm text-slate-600 hover:text-brand-orange p-2 rounded-lg hover:bg-slate-50 transition-colors">
                              <Briefcase className="h-4 w-4 text-slate-400" /> 
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          <li>
                            <Link to="/mxe-tv" className="flex items-center gap-3 text-sm text-slate-600 hover:text-brand-orange p-2 rounded-lg hover:bg-slate-50 transition-colors">
                              <Tv className="h-4 w-4 text-slate-400" /> 
                              <span>MXE TV</span>
                            </Link>
                          </li>
                          <li>
                            <Link to="/about" className="flex items-center gap-3 text-sm text-slate-600 hover:text-brand-orange p-2 rounded-lg hover:bg-slate-50 transition-colors">
                  ...
                  <div className="col-span-1 p-6 bg-slate-50 border-l border-slate-100">
                    <h4 className="font-semibold text-sm mb-4 text-slate-900">Strategic Partners</h4>
                    <div className="space-y-4">
                      <Link to="/partners/nora" className="block group bg-white p-3 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-brand-orange/30 transition-all">
                        <div className="flex items-center gap-2 mb-1 group-hover:text-brand-orange transition-colors">
                          ...
                          <span className="text-sm font-bold">NORA</span>
                        </div>
                        <p className="text-[10px] text-slate-500 leading-tight">Future Technologies Partner</p>
                      </Link>
                      
                      <Link to="/partners/reetoken" className="block group bg-white p-3 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-brand-orange/30 transition-all">
                        <div className="flex items-center gap-2 mb-1 group-hover:text-brand-orange transition-colors">
                          <div className="bg-slate-900 p-1 rounded text-white">
                            <Gem className="h-3 w-3" />
                          </div>
                          <span className="text-sm font-bold">REEToken</span>
                        </div>
                ...
                <DropdownMenuContent className="w-80 p-0" align="end" forceMount>
                  ...
                  <div className="p-2 space-y-1">
                    ...
                    <DropdownMenuItem asChild className="cursor-pointer rounded-lg px-3 py-2.5 focus:bg-slate-50">
                      <Link to="/how-to-guides" className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-medium text-slate-700">Help & Guides</span>
                      </Link>
                    </DropdownMenuItem>
                  </div>
                  ...
                  <div className="p-4">
                    <div className="bg-slate-50 rounded-lg p-3 border border-slate-100 flex items-center justify-between">
                      <div>
                        <p className="text-sm font-semibold text-slate-900">Starter Plan</p>
                        <p className="text-xs text-slate-500">Free until May 1st 2026</p>
                      </div>
                      <Button size="sm" variant="outline" className="h-8 bg-white border-slate-200 text-slate-900 hover:text-brand-orange hover:border-brand-orange/30 text-xs" asChild>
                ...
                <details className="group">
                  ...
                  <div className="pl-3 mt-1 space-y-2">
                    <Link to="/partners/nora" className="flex items-center gap-2 text-xs text-slate-600 py-1 hover:text-brand-orange" onClick={() => setIsMobileMenuOpen(false)}>
                      <div className="bg-blue-600 p-0.5 rounded text-white"><Cpu className="h-3 w-3" /></div>
                      <span className="font-medium">NORA</span>
                    </Link>
                    <Link to="/partners/reetoken" className="flex items-center gap-2 text-xs text-slate-600 py-1 hover:text-brand-orange" onClick={() => setIsMobileMenuOpen(false)}>
                      <div className="bg-slate-900 p-0.5 rounded text-white"><Gem className="h-3 w-3" /></div>
                      <span className="font-medium">REEToken</span>
                    </Link>
                  </div>
                </details>
