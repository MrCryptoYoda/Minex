        ...
        <section className="relative h-[600px] w-full overflow-hidden rounded-3xl flex items-center">
          ...
          <div className="relative z-10 text-white px-8 md:px-16 max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="h-10 w-10 bg-blue-600 rounded flex items-center justify-center font-bold text-xl shadow-lg shadow-blue-900/20">N</div>
              <div className="flex flex-col items-start leading-none">
                <span className="font-bold text-lg tracking-wide">NORA</span>
                <span className="text-[0.6rem] uppercase tracking-widest opacity-80 font-medium">Future Technologies</span>
              </div>
            </div>
